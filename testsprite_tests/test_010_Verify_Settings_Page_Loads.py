...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the settings page by clicking or direct URL to verify it loads successfully without 404 error and contains settings content.
        ...
        await expect(frame.locator('text=Profile Settings').first).to_be_visible(timeout=30000)
        ...
        await expect(frame.locator('text=Manage privacy settings').first).to_be_visible(timeout=30000)
