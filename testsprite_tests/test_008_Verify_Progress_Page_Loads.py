...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /progress page to verify it loads successfully without 404 error and contains progress content.
        ...
        await expect(frame.locator('text=5 of 12 lessons').first).to_be_visible(timeout=30000)
