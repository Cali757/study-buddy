...
export default function LessonPage({ params }: { params: Promise<{ id: string }> | { id: string } }) {
  // Next.js 15 may provide params as a Promise; unwrap with React.use to avoid runtime warnings.
  const { id: lessonId } = typeof (params as any).then === 'function' ? use(params as Promise<{ id: string }>) : (params as { id: string });
