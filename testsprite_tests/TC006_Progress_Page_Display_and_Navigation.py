...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password to sign in and then navigate to /progress page.
        ...
        try:
            ...
            raise AssertionError("Test case failed: The user progress page did not load correctly with appropriate progress tracking UI or there were errors on the page as per the test plan.")
